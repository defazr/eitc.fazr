...
export const metadata: Metadata = {
  ...
  description:
    "근로·자녀장려금 신청 방법, 대상 기준, 맞벌이 가능 여부, 1인 가구 지원금, K패스 연계, 금리인하 등 자주 묻는 질문 총정리.",
...
const FAQ_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: "근로·자녀장려금 사용처 제한이 있나요?",
        a: '신용카드·체크카드 포인트 충전 또는 지역사랑상품권으로 지급될 예정입니다. 사용 기한이 설정될 가능성이 있으며, 미사용 잔액은 국고 환수될 수 있습니다. <a href="/calculator" class="text-primary underline">예상 금액 계산하기</a>',
      },
    ],
  },
  {
